...
<div>
	<form method="post" id="acct_form" class="easyui-form" data-options="novalidate:true" enctype="multipart/form-data">
		...
		<tr >
				...
				<td>
					<input id="acct_license" type="radio" checked name="a" value="1"/><span>营业执照</span>
					<span style="float:right;"><input id="acct_taxCard" type="radio" name="a" value="2"/><span>税务登记证</span></span>
					<br/>
					<input id="acct_orgCode" type="radio" name="a" value="3"/><span>组织机构代码证</span>
				</td>
				<td class="hintspace">
					<tt>*</tt> 
				</td>				
